...
L'ensemble des personnages du jeu, que ce soit le h�ros ou le pnj ne peuvent faire qu'une seule action par tour.
...
Le h�ros ne peut faire qu'une seule action par tour. 
...
Le samaritain ne demande rien en échange de ses informations / objets.
